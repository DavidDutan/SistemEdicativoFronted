...
export class DetalleMatriculaService {
  ...
  save (detMatricula: DetalleMatricula): Observable<any[]> {
      return this.http.post<any>('http://localhost:8080/detalleMatricula/registrar', detMatricula)
  }

  getAllEstudiantes(): Observable<any[]>{
    return this.http.get<any>('http://localhost:8080/detalleMatricula/listar')
  }
}
